...
```{r,echo=FALSE}
# Set the directory where you installed the files
#working_dir <- "C:\\Users\\pnlawlor\\GoogleDrive\\Research\\Projects\\GWTG_RDD\\"
#setwd(working_dir)
```
...
Here we will simulate the setting in which there is a simple causal effect of tPA administration on clinical outcome. In this dataset, we will assume that the threshold for tPA administration (3 hours) is always followed, meaning that there should be a sharp discontinuity between outcomes on the left side of the threshold and on the right. 
...
(plot1 <- ggplot(df1, aes(xx,yy)) + 
    ...
    ylab("Good disposition probability") +
